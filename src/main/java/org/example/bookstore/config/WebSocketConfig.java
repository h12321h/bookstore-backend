...
import org.example.bookstore.handler.CustomWebSocketHandler;
import org.example.bookstore.interceptor.CustomHandshakeInterceptor;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(webSocketHandler, "/ws-orders")
                ...
                .setAllowedOrigins("http://localhost:3000")  // 允许的来源
